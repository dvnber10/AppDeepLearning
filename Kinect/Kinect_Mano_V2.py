...
from extracciónTexto import extract_text_from_image_1
from text_to_speech import text_to_speech_perfect
from envio_ESP32 import send_to_esp32
...
class KinectPaint(QWidget):
    ...
    def extract_text_from_image(self, image_path):
        try:
            ...
            text_to_speech_perfect(txt_filename)
            send_to_esp32(txt_filename)
            return text
        except Exception as e:
